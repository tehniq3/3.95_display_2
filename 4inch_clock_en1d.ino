...
*/
    printText("Temperature", GREEN,25,195,2);  // Temperature Static Text
    printText("Alarma is seta at:", MAGENTA,235,195,2);
    printText("Termomether & Alarm Clock with Arduino", DARKGREEN,225,295,1);
    printText("Due, DS18B20, DS3231 on 10cm display.", DARKGREEN,225,305,1);
